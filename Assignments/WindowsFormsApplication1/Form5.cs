...
namespace WindowsFormsApplication1
{
    public partial class Form5 : Form
    {
        ...
        private void insertbtn_Click(object sender, EventArgs e)
        {
            ...
            { 
                string sqlInsert;
                sqlInsert = "insert into Salary (EmPID,EmpName,Month, No_pay_value,Base_pay_value,Gross_pay_value) values ('" + empidtxt.Text + "','" + nametxt.Text + "','" + comboBox1.Text + "','" + nopaytxt.Text + "','" + basepaytxt.Text + "','" + grosspaytxt.Text + "')";
