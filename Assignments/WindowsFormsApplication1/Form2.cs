...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string sqlsearch;
                sqlsearch = "Select * from Employee where EmpID = '" + comboBox1.Text + "'";
        ...
        private void insrtbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlInsert;
                sqlInsert = "insert into Employee (EmPID,EmpName,Age,Gender,Contact_Number,Email,Joined_Date,Salary, OT_Rate,Allowance) values ('" + empidtxt.Text + "','" + nametxt.Text + "','" + agetxt.Text + "','" + gen + "','" + contacttxt.Text + "','" + emailtxt.Text + "','" + dateTimePicker1.Value + "','" + saltxt.Text + "','" + otrtxt.Text + "','" + allwnstxt.Text + "')";
        ...
        private void updtbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (radioButton1.Checked == true)
                    ...
                    gen = "F";
                string sqlUpdate;
                sqlUpdate = "update Employee set EmpName= '" + nametxt.Text + "', Age = '" + agetxt.Text + "' , Gender = '" + "" + gen + "' ,Contact_Number = '" + contacttxt.Text + "', Email = '" + emailtxt.Text + "' , joined_Date  = '" + dateTimePicker1.Value + "' , Salary = '" + saltxt.Text + "',OT_Rate= '" + otrtxt.Text + "' , Allowance= '" + allwnstxt.Text + "' Where EmpID = '" + comboBox1.Text + "'";
        ...
        private void delbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                string sqlDel;
                sqlDel = "delete from Employee where EmpID ='" + comboBox1.Text + "'";
